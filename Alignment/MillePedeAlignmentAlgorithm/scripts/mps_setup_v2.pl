...
for ($j = 1; $j <= $nJobs; ++$j) {
  ...
  print "mps_splice_v2.py $cfgTemplate jobData/$theJobDir/theSplit jobData/$theJobDir/the.py $theIsn\n";
  system "mps_splice_v2.py $cfgTemplate jobData/$theJobDir/theSplit jobData/$theJobDir/the.py $theIsn";
